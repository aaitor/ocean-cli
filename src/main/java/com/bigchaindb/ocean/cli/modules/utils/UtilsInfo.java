package com.bigchaindb.ocean.cli.modules.utils;

import com.bigchaindb.ocean.cli.UtilsCLI;
...
public class UtilsInfo implements Callable {
    ...
    CommandResult info() throws CLIException {
        ...
        try {
            System.out.println("Querying resource: " + url);
            ...
            System.out.println();
            System.out.println(CommandLineHelper.prettyJson(metadataFileToJson(file)));
